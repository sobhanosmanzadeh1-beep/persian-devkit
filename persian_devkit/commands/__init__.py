...
__all__ = [
    ...
    "date_cmd", "dns_cmd", "env_cmd", "extract_cmd", "frequency_cmd",
    "gitignore_cmd", "hash_cmd", "hijri_cmd", "http_cmd", "image_cmd",
    "ip_cmd", "jq_cmd", "json_cmd", "license_cmd", "lorem_cmd",
    "name_cmd", "number_cmd", "numerals_cmd", "password_cmd",
    "ping_cmd", "port_cmd", "qrcode_cmd", "random_cmd", "scaffold_cmd",
    "security_cmd", "sort_cmd", "sys_cmd", "template_cmd", "text_cmd",
