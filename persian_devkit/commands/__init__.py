...
__all__ = [
    ...
    "env_cmd", "gitignore_cmd", "hash_cmd", "hijri_cmd", "image_cmd",
    "jq_cmd", "json_cmd", "license_cmd", "lorem_cmd", "name_cmd",
    "number_cmd", "numerals_cmd", "password_cmd", "qrcode_cmd",
    "random_cmd", "scaffold_cmd", "sort_cmd", "template_cmd",
    "text_cmd", "time_cmd", "toml_cmd", "translit_cmd", "url_cmd",
    "uuid_cmd", "yaml_cmd",
]
